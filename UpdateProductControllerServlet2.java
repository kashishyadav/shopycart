 ...
 * @author Aftab
 */
public class UpdateProductControllerServlet2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("product id is :"+pid);
            ItemDTO obj=StoreDAO.getItemDetailsById(pid);
            request.setAttribute("itemDetails", obj);
            rd=request.getRequestDispatcher("updateProduct2.jsp");
