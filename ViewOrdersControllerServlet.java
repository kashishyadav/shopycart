 ...
 * @author Aftab
 */
public class ViewOrdersControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ArrayList<OrderDTO> orders=StoreDAO.getOrders();
         ...
         catch(Exception e)
        {
            ...
            System.out.println("Exception from ViewOrders:"+e);
            e.printStackTrace();
        }
        finally
        {
